---
name: BackendSelection.jl bug report
about: Create a bug report to help us improve BackendSelection.jl
...
[YOUR OUTPUT HERE]
```
 - Output from `using Pkg; Pkg.status("BackendSelection")`:
```julia
julia> using Pkg; Pkg.status("BackendSelection")
[YOUR OUTPUT HERE]
```
